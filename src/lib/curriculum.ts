...
Object.assign(TOPIC_BANK, EXTRA_TOPICS, {
  ...
  "organizational behavior": [
    "Introduction to Organizational Behavior & Overview",
    "Personality & Values in the Workplace",
    "Perception, Attribution & Decision Making",
    "Learning Theories & Reinforcement",
    "Attitudes, Job Satisfaction & Work Emotions",
    "Foundational Theories of Motivation",
    "Applied Motivation & Job Design",
    "Group Dynamics & High-Performance Teams",
    "Interpersonal & Organizational Communication",
    "Foundational Leadership Models & Traits",
    "Contemporary Leadership & Influence",
    "Power, Organizational Politics & Ethics",
    "Conflict Management & Negotiation Strategies",
    "Organizational Structure & Work Stress",
...
const RULES: Rule[] = [
  ...
  { match: /nmims|cdoe|nga-sce|online.*mba.*marketing|distance.*mba.*marketing/i, subjects: [
    // NMIMS CDOE MBA structure: core papers + marketing electives. Authentic unit counts:
    sub("Business Communication", 10, "Medium"), sub("Financial Accounting", 12, "Medium"),
    sub("Micro Economics", 10, "Hard"), sub("Macro Economics", 10, "Hard"), sub("Organizational Behavior", 16, "Medium"),
    sub("Marketing Management", 14, "Hard"), sub("Quantitative Methods", 12, "Hard"),
    sub("Cost & Management Accounting", 12, "Hard"), sub("Human Resource Management", 10, "Medium"),
    sub("Strategic Management", 12, "Hard"), sub("Business Analytics", 10, "Hard"),
    sub("Legal Aspect of Business", 10, "Medium"), sub("Operations Management", 12, "Medium"),
    sub("Corporate Finance", 12, "Hard"), sub("Research Methodology", 10, "Hard"),
    sub("Project Part I", 6, "Medium"), sub("Brand Management", 12, "Hard"),
    sub("Consumer Behaviour", 12, "Hard"), sub("Integrated Marketing Communications", 12, "Hard"),
    sub("Sales Management", 10, "Medium"), sub("Indian Ethos & Ethics", 8, "Easy"),
    sub("Corporate Sustainability", 8, "Medium"), sub("International Business", 10, "Medium"),
    sub("Project Part II", 6, "Hard"), sub("International Marketing", 12, "Hard"),
    sub("Services Marketing", 10, "Medium"), sub("Digital Marketing", 12, "Hard")
  ] },
