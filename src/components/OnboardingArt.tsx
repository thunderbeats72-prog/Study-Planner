...
function Books({ filterId, gradientId }: { filterId: string; gradientId: string }) {
  return <g filter={`url(#${filterId})`}>
    ...
    <path d="M88 121h70" stroke="#fff" strokeOpacity=".56" strokeWidth="2" />
    <path d="M91 99c0-5 4-9 9-9h64c5 0 9 4 9 9v9H91v-9Z" fill="#C99AF7" />
    <path d="M95 97h74" stroke="#fff" strokeOpacity=".62" strokeWidth="2" />
    <path d="M107 80c0-5 4-8 9-8h53c5 0 8 3 8 8v8h-70v-8Z" fill={`url(#${gradientId})`} opacity=".9" />
    <path d="M111 79h62" stroke="#fff" strokeOpacity=".54" strokeWidth="2" />
  </g>;
}

function TinyPlant({ filterId }: { filterId: string }) {
  return <g filter={`url(#${filterId})`}>
    <path d="M267 115h39l-5 19h-29l-5-19Z" fill="#F8F6FF" stroke="var(--accent)" strokeOpacity=".2" />
    <path d="M286 115v-24" stroke="#309B71" strokeWidth="2.4" />
    <path d="M285 102c-18-4-17-18-15-23 13 2 18 10 15 23Z" fill="#55BE8B" />
    <path d="M287 98c4-16 16-17 22-16-1 12-8 18-22 16Z" fill="#34A979" />
    <path d="M284 110c-12-2-16-10-15-16 10 1 16 5 15 16Z" fill="#79CFA2" />
  </g>;
}
      ...
      <svg viewBox="0 0 360 170" fill="none" role="presentation">
        ...
        {variant === "you" && <>
          ...
          <g filter={`url(#${id}-shadow)`}>
            <rect x="160" y="47" width="77" height="85" rx="10" fill="#FDFCFF" stroke={`url(#${id}-purple)`} strokeWidth="4" />
        ...
        {variant === "level" && <>
          ...
          <g filter={`url(#${id}-shadow)`}>
            ...
            <circle cx="254" cy="108" r="5" fill="#E8BD70" />
            <path d="m156 72 33 15 33-15-33-15-33 15Z" fill="#fff" opacity=".24" />
          </g>
          <TinyPlant filterId={`${id}-shadow`} />
        </>}
        ...
        {variant === "course" && <>
          <Books filterId={`${id}-shadow`} gradientId={`${id}-purple`} />
          <g filter={`url(#${id}-shadow)`}>
            <path d="M152 63c21-12 40-11 57 3v56c-17-12-36-13-57-2V63Z" fill="#FDFCFF" stroke={`url(#${id}-purple)`} strokeWidth="3.5" />
            <path d="M209 66c18-14 38-15 57-3v57c-19-11-38-10-57 2V66Z" fill="#FDFCFF" stroke={`url(#${id}-purple)`} strokeWidth="3.5" />
            <path d="M164 80h31M164 91h26M222 80h31M222 91h25" stroke="var(--accent)" strokeWidth="3" strokeLinecap="round" opacity=".28" />
            <circle cx="255" cy="55" r="22" fill="#FDFCFF" stroke={`url(#${id}-purple)`} strokeWidth="5" />
        ...
        {variant === "details" && <>
          <Books filterId={`${id}-shadow`} gradientId={`${id}-purple`} />
          <g filter={`url(#${id}-shadow)`}>
            <rect x="160" y="43" width="76" height="91" rx="11" fill="#FDFCFF" stroke={`url(#${id}-purple)`} strokeWidth="4" />
            ...
            <path d="m247 119 25-48 11 6-25 48-15 5 4-11Z" fill="#C99AF7" stroke="var(--accent)" strokeWidth="2.5" />
            <path d="m272 71 6-11 11 6-6 11-11-6Z" fill="#F4C98D" />
          </g>
          <TinyPlant filterId={`${id}-shadow`} />
        </>}
        ...
        {variant === "syllabus" && <>
          <g filter={`url(#${id}-shadow)`}>
            ...
            <path d="M121 95c0-6 4-10 10-10h105c6 0 10 4 10 10v13H121V95Z" fill="#C99AF7" />
            <path d="M134 69c0-6 4-10 10-10h82c6 0 10 4 10 10v15H134V69Z" fill={`url(#${id}-purple)`} opacity=".92" />
            <path d="M135 113h96M142 89h91M151 64h72" stroke="#fff" strokeOpacity=".56" strokeWidth="2.5" />
            <path d="M202 59v27l-9-7-9 7V59h18Z" fill="#F2B3E0" />
          </g>
          <TinyPlant filterId={`${id}-shadow`} />
        </>}
        ...
        {variant === "style" && <>
          ...
          <g filter={`url(#${id}-shadow)`}>
            ...
            <path d="M174 85c0-13 7-24 18-29" stroke="#fff" strokeOpacity=".62" strokeWidth="4" strokeLinecap="round" />
            <path d="M189 16v11M135 45l10 8M243 45l-10 8M126 86h13M252 86h-13" stroke="#E9BD70" strokeWidth="3" strokeLinecap="round" opacity=".82" />
            <circle cx="189" cy="78" r="15" fill="#fff" opacity=".18" />
          </g>
          <TinyPlant filterId={`${id}-shadow`} />
        </>}
        ...
        {variant === "rhythm" && <>
          <Books filterId={`${id}-shadow`} gradientId={`${id}-purple`} />
          <g filter={`url(#${id}-shadow)`}>
            <circle cx="207" cy="88" r="42" fill="#FDFCFF" stroke={`url(#${id}-purple)`} strokeWidth="5" />
        ...
        {variant === "review" && <>
          ...
          <g filter={`url(#${id}-shadow)`}>
            ...
            <path d="M253 45c15 10 28 8 39 0-3 16-20 26-39 16V45Z" fill="#F2B3E0" stroke="var(--accent)" strokeWidth="2" />
          </g>
          <TinyPlant filterId={`${id}-shadow`} />
        </>}
      </svg>
