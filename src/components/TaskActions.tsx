...
export default function TaskActions({ task, subject, activeTaskId, clockSessionActive, onTaskStatus, onFocusTask, onClockOut, onEdit, onSkipSubject }: {
  ...
  return <>
    {/* The menu trigger is a task-row-level control, not part of the action
        button grid. This gives the ⋮ its own hit area and prevents it from
        overlapping Clock Out/Done on desktop or mobile. */}
