 ...
 *
 * One component, eight variants, drawn with `currentColor` strokes over an
 * accent-tinted tile, so every step gets a small "image" that follows the
 * active theme for free (no binary assets, no per-theme files). All variants
